    ...
    <Layout>
      <PageSection color={color}>
        <PageWrapper>
          <article>
            <motion.h1
              data-text="I'm MOHAMMED AMJAD"
              className="intro__text"
              {...getTransitions(0.1)}
            >
              <mark className="mark">I&apos;m MOHAMMED AMJAD</mark>
            </motion.h1>
            <motion.p {...getTransitions(0.3)}>
              {' '}
              A skilled and motivated frontend developer with expertise in
              JavaScript, UX design, and creating engaging web interfaces.
              Committed to delivering high-quality results and thriving in a
              collaborative and dynamic environment. Enthusiastic about
              photochromic lenses and minimalist design. I bring ideas to life
              through various{' '}
              <Link href="/projects" aria-label="Go to Projects Page">
                Projects
              </Link>{' '}
              , including interactive web applications and immersive user
              experiences. Always open to new connections and opportunities.
            </motion.p>
            <motion.p {...getTransitions(0.5)}>
              A true minimalist at heart, I find elegance in simplicity and
              order. Beyond coding, I am an avid cricket enthusiast, enjoying
              both playing and watching the sport. anyways you can{' '}
